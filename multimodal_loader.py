...
Handles loading varios document types including PDFs, Word docs, Excel files, and text files
"""
#%%
import os
...
class MultiFormatDocumentLoader:
    ...
    def load_multiple_document(self, file_paths: List[Union[str, Path]]) -> List[Document]:
        """
        Load multiple documents from a list of file paths

        Args:
            file_paths: List of pahts to document files
    ...
    def load_directory(self, directory_path: Union[str, Path], recursive: bool=True) -> List[Document]:
        ...
        return self.load_multiple_document(all_files)
...
if __name__ == "__main__":
    ...
    # documents = loader.load_document("peri peri asins.xlsx")
    # print(f"Loaded {len(documents)} documents")
    # print(f"Document is this {documents}")
