...
system = """You are an expert question-answer relevance evaluator for a converstaional AI system. Your role is to assess whether a generated answer properly addresses and resolves the user's question.
...
1. DIRECT RELEVANCE:
    ...
    - Is the anser focused on what the user actually wants to know?

2. COMPLETENESS ASSESSMENT:
    - Does the ansewr cover all important aspects of the question?
...
4. USEFULNESS FOR USER:
    ...
    - Is the ansewr actionable or informative as requested?
...
- Identify any misisng key aspects if the answer is incomplete
...
relevance_prompt = ChatPromptTemplate.from_messages(
    [
        ...
        ("human", """Please evaluate whether the generated answer properly addresses the user's question.
         ...
         EVALUATION REQUIRED:
         1. Binary Score: true if answer addresses questoin adequately, false if not
         2. Relevance Score: 0.0-1.0 rating of how well ansewr addresses the question
