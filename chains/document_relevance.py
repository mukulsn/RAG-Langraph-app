...
from pydantic import BaseModel, Field # this act as bouncer for data
...
system = """You are an expert document relevance evaluator. Your task is to determine whether an LLM-generated answer is properly grounded in the provided source document
...
- Minor paraphrashing or reasonable inference from the documents is acceptable
- The answer should not include fabricated informatoin or external knowlgedge not present in the documents
...
relevance_prompt = ChatPromptTemplate.from_messages(
    [
        ...
        ("human", """Please evaluate whether the LLM generation is grounded in the provided documents.
         ...
         Provide:
         1. A binary score (true/false) indication if the answer is grounded in the documents
         2. A confidence score (0.0-1.0) for your evaluation
         3. A brief reasoning explaning your decision
