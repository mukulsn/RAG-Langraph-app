...
class GraphState(TypedDict):
    ...
    Each step in the worklfow can read from and write to this state, allowing
    ...
    document_evaluations: Optional[List[Dict[str, Any]]] # Store document evaluatoin results
