...
class DocumentProcessor:
    ...
    def _execute_processing_pipeline(self, user_file, file_info, current_file_key):
        ...
        try:
            ...
            st.session_state.receiver = retriever

            # Debug: Confirm retriever creation and test it
            print(f"Retriver created successfully: {retriever is not None}")
            ...
            try:
                ...
                print(f"Retriver test successful - found {len(test_docs)} documents")
            except Exception as e:
    ...
    def _create_document_chunks(self, documents):
        ...
        for i, split in enumerate(doc_splits):
            ...
            split.metadata.update(documents[original_doc_index].metadata) # search about this
    ...
    def create_vector_database(self, doc_splits):
